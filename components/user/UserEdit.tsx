...
const UserEdit: React.FC<IUserEditProps> = ({ updateModal }) => {
  ...
  const showCroppedImage = useCallback(async () => {
    try {
      ...
      case 1:setBanner_1(croppedImage as string);break
      case 2:setBanner_2(croppedImage as string);break
      case 3:setBanner_3(croppedImage as string);break
      }
      setCropDlgOpen(false)
    } catch (e) {
      console.error(e)
                ...
                <div className="flex flex-row my-4">
                  ...
                  <div className="inline-block align-middle ml-4">
                    ...
                    <span
                      ...
                      className={classNames('basis-1/6', 'items-center', editStyle.etherspan)}
                    >
                      <input className="w-32 my-4 font-['Circular_Std'] not-italic text-[16px] leading-[20px] text-[#ADB5BD]" type="text" defaultValue="0.0005" />
                    </span>
                  </div>
                </div>
              </div>
